<template>
  <div class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-600 py-4">
    <div class="max-w-screen-xl mx-auto px-4">
      <div class="flex flex-wrap justify-between items-center">
        <div class="dark:text-gray-400">
          &copy; 2024 Josue Cerron Tuesta - Software Engineer. All rights reserved.
        </div>
